...
4.  Add it to the list of Vagrant boxes.  See
    ...
    more information.
        ...
        $ vagrant box add builds/FreeBSD-12.1-RELEASE-amd64.box --name FreeBSD-12.1-RELEASE-amd64
...
Vagrant.configure(2) do |config|
  servers.each do |server|
    config.vm.define server[:name] do |box|
      box.vm.box      = 'FreeBSD-12.1-RELEASE-amd64'
...
-   `revision` is the FreeBSD revision number.  _Default:_ `12.1`
